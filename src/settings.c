...
#define SETTINGS_DEFAULT_WINDOW_WIDTH  (SCREEN_W * 2)
#define SETTINGS_DEFAULT_WINDOW_HEIGHT (SCREEN_H * 2)
#elif defined(PLATFORM_WEB)
#define SETTINGS_DEFAULT_WINDOW_WIDTH  (SCREEN_W * 2)+32
#define SETTINGS_DEFAULT_WINDOW_HEIGHT (SCREEN_H * 2)+32
#endif
