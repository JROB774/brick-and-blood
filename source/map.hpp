...
GLOBAL constexpr int WORLD_W = 128; // In chunks!
GLOBAL constexpr int WORLD_H = 128;
...
GLOBAL constexpr int MIN_ENTITY_SPAWN_RADIUS  = 25; // Area where entities can spawn.
GLOBAL constexpr int MAX_ENTITY_SPAWN_RADIUS  = 45;
GLOBAL constexpr int MAX_ENTITY_ACTIVE_RADIUS = 25; // Area where entities start to despawn.
