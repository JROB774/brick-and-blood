...
INTERNAL void DrawImage (std::string image_name, float x, float y, float angle = 0.0f, Flip flip = FLIP_NONE, Vec4 color = { 1,1,1,1 }, const SDL_Rect* clip = NULL); // Angle in degrees!
